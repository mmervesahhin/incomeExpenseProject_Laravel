                            ...
                            <div class="box">
                                <div class="box-body d-flex pb-0">
                                    <div class="me-auto">
                                        ...
                                        <p class="fs-16 mb-0 mt-2"><span class="text-primary">87 </span>left from
                                            target</p>
                                    </div>
                            ...
                            <div class="box">
                                <div class="box-body d-flex pb-0">
                                    <div class="me-auto">
                                        ...
                                        <p class="fs-14 mb-0 mt-11"><span class="text-primary">-3% </span>than last
                                            month</p>
                                    </div>
                            ...
                            <div class="owl-carousel owl-theme">
                                <div class="box box-carousel">
                                    <div class="card-top">
                                        <div class="sm-f-wrap d-flex">
                                            ...
                                            <a href="{{ asset('assets/auth/project-details.html') }} }}" class="h5 t-title">Gold App</a>
                                        </div>
                                        <div class="dropdown">
                                    ...
                                    <div class="card-center">
                                        ...
                                        <div class="sm-f-wrap d-flex justify-content-between">
                                            <ul class="user-list">
                                                <li><img src="{{ asset('assets/auth/images/avatar/user-1.png') }}" alt="user"></li>
                                                <li><img src="{{ asset('assets/auth//images/avatar/user-2.png') }}" alt="user"></li>
                                                <li><img src="{{ asset('assets/auth//images/avatar/user-3.png') }}" alt="user"></li>
                                                <li><img src="{{ asset('assets/auth//images/avatar/user-4.png') }}" alt="user"></li>
                                                <li><img src="{{ asset('assets/auth//images/avatar/user-5.png') }}" alt="user"></li>
                                            </ul>
                                ...
                                <div class="box box-carousel">
                                    <div class="card-top">
                                        <div class="sm-f-wrap d-flex">
                                            ...
                                            <a class="h5 t-title" href="{{ asset('assets/auth/project-details.html') }}">Landing Page</a>
                                        </div>
                                        <div class="dropdown">
                                            <a href="javascript:void(0);" class="btn-link" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                ...
                                <div class="box box-carousel">
                                    <div class="card-top">
                                        <div class="sm-f-wrap d-flex">
                                            ...
                                            <a class="h5 t-title" href="{{ asset('assets/auth/project-details.html') }}">App Landing UI</a>
                                        </div>
                                        <div class="dropdown">
                                            <a href="javascript:void(0);" class="btn-link" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                ...
                                <div class="box box-carousel">
                                    <div class="card-top">
                                        <div class="sm-f-wrap d-flex">
                                            ...
                                            <a class="h5 t-title" href="{{ asset('assets/auth/project-details.html') }}">Blog Template UI</a>
                                        </div>
                                        <div class="dropdown">
                                            <a href="javascript:void(0);" class="btn-link" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                ...
                                <div class="box box-carousel">
                                    <div class="card-top">
                                        <div class="sm-f-wrap d-flex">
                                            <h5 class="icon-gold text-white bg-green">G</h5>
                                            <a class="h5 t-title" href="{{ asset('assets/auth/project-details.html') }}">Brand logo design</a>
                                        </div>
                                        <div class="dropdown">
                                            <a href="javascript:void(0);" class="btn-link" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                ...
                                <div class="box box-carousel">
                                    <div class="card-top">
                                        <div class="sm-f-wrap d-flex">
                                            <h5 class="icon-gold text-white bg-yellow">G</h5>
                                            <a class="h5 t-title" href="{{ asset('assets/auth/project-details.html') }}">Gold App</a>
                                        </div>
                                        <div class="dropdown">
                                            <a href="javascript:void(0);" class="btn-link" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                ...
                                <div class="box box-carousel">
                                    <div class="card-top">
                                        <div class="sm-f-wrap d-flex">
                                            <h5 class="icon-gold text-white bg-blue">G</h5>
                                            <a class="h5 t-title" href="{{ asset('assets/auth/project-details.html') }}">New Landing Design</a>
                                        </div>
                                        <div class="dropdown">
                                            <a href="javascript:void(0);" class="btn-link" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                ...
                                <div class="box box-carousel">
                                    <div class="card-top">
                                        <div class="sm-f-wrap d-flex">
                                            <h5 class="icon-gold text-white bg-orange">G</h5>
                                            <a class="h5 t-title" href="{{ asset('assets/auth/project-details.html') }}">Skote Dashboard UI</a>
                                        </div>
                                        <div class="dropdown">
                                            <a href="javascript:void(0);" class="btn-link" data-bs-toggle="dropdown"
                                                aria-expanded="false">
